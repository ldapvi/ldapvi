...
run() {
    ...
    result=$(HOME=$base $base/$BINDIR/$prog $* 2>&1)
...
run_diff() {
    ...
    out=$base/tmp.out
    diff_file=$base/tmp.diff

    echo Running test $name.

    $base/$BINDIR/$prog $in_file > $out
    ret=$?
...
# Begin test1 test
###################
run $PROG1 "test1 - 1" "arg1: 1 arg2: (none)" --arg1
run $PROG1 "test1 - 2" "arg1: 0 arg2: foo" --arg2 foo
run $PROG1 "test1 - 3" "arg1: 1 arg2: something" --arg1 --arg2 something
run $PROG1 "test1 - 4" "arg1: 0 arg2: another" --simple another
run $PROG1 "test1 - 5" "arg1: 1 arg2: alias" --two
run $PROG1 "test1 - 6" "arg1: 1 arg2: (none) rest: --arg2" --arg1 -- --arg2 
run $PROG1 "test1 - 7" "arg1: 0 arg2: abcd rest: --arg1" --simple abcd -- --arg1 
run $PROG1 "test1 - 8" "arg1: 1 arg2: (none) rest: --arg2" --arg1 --takerest --arg2 
run $PROG1 "test1 - 9" "arg1: 0 arg2: foo" -2 foo
run $PROG1 "test1 - 10" "arg1: 0 arg2: (none) arg3: 50" -3 50
run $PROG1 "test1 - 11" "arg1: 0 arg2: bar" -T bar
run $PROG1 "test1 - 12" "arg1: 1 arg2: (none)" -O 
run $PROG1 "test1 - 13" "arg1: 1 arg2: foo" -OT foo
run $PROG1 "test1 - 14" "arg1: 0 arg2: (none) inc: 1" --inc
run $PROG1 "test1 - 15" "arg1: 0 arg2: foo inc: 1" -I --arg2 foo
POSIX_ME_HARDER=1 ; export POSIX_ME_HARDER
run $PROG1 "test1 - 16" "arg1: 1 arg2: (none) rest: foo --arg2 something" --arg1 foo --arg2 something
unset POSIX_ME_HARDER
POSIXLY_CORRECT=1 ; export POSIXLY_CORRECT
run $PROG1 "test1 - 17" "arg1: 1 arg2: (none) rest: foo --arg2 something" --arg1 foo --arg2 something
unset POSIXLY_CORRECT
run $PROG1 "test1 - 18" "callback: c sampledata bar arg1: 1 arg2: (none)" --arg1 --cb bar
run $PROG1 "test1 - 19" "" --echo-args
run $PROG1 "test1 - 20" "--arg1" --echo-args --arg1
run $PROG1 "test1 - 21" "--arg2 something" -T something -e
run $PROG1 "test1 - 22" "--arg2 something more args" -T something -a more args
run $PROG1 "test1 - 23" "--echo-args -a" --echo-args -e -a
run $PROG1 "test1 - 24" "arg1: 0 arg2: (none) short: 1" -onedash
run $PROG1 "test1 - 25" "arg1: 0 arg2: (none) short: 1" --onedash
run $PROG1 "test1 - 26" "callback: c arg for cb2 foo arg1: 0 arg2: (none)" --cb2 foo
run $PROG1 "test1 - 27" "arg1: 0 arg2: (none) rest: -" -
run $PROG1 "test1 - 28" "arg1: 0 arg2: foo rest: -" - -2 foo
run $PROG1 "test1 - 29" "arg1: 0 arg2: bbbb" --arg2=aaaa -2 bbbb
run $PROG1 "test1 - 30" "arg1: 0 arg2: 'foo bingo' rest: boggle" --grab bingo boggle
run $PROG1 "test1 - 31" "arg1: 0 arg2: 'foo bar' rest: boggle" --grabbar boggle

run $PROG1 "test1 - 32" "arg1: 0 arg2: (none) aInt: 123456789" -i 123456789
run $PROG1 "test1 - 33" "arg1: 0 arg2: (none) aInt: 123456789" --int 123456789
run $PROG1 "test1 - 34" "arg1: 0 arg2: (none) aShort: 12345" -s 12345
run $PROG1 "test1 - 35" "arg1: 0 arg2: (none) aShort: 12345" --short 12345
run $PROG1 "test1 - 36" "arg1: 0 arg2: (none) aLong: 1123456789" -l 1123456789
run $PROG1 "test1 - 37" "arg1: 0 arg2: (none) aLong: 1123456789" --long 1123456789
run $PROG1 "test1 - 38" "arg1: 0 arg2: (none) aLongLong: 1111123456789" -L 1111123456789
run $PROG1 "test1 - 39" "arg1: 0 arg2: (none) aLongLong: 1111123456789" --longlong 1111123456789

run $PROG1 "test1 - 40" "arg1: 0 arg2: (none) aFloat: 10.1" -f 10.1
run $PROG1 "test1 - 41" "arg1: 0 arg2: (none) aFloat: 10.1" --float 10.1
run $PROG1 "test1 - 42" "arg1: 0 arg2: (none) aDouble: 10.1" -d 10.1
run $PROG1 "test1 - 43" "arg1: 0 arg2: (none) aDouble: 10.1" --double 10.1

run $PROG1 "test1 - 44" "arg1: 0 arg2: (none) oStr: (none)" --optional
run $PROG1 "test1 - 45" "arg1: 0 arg2: (none) oStr: yadda" --optional=yadda
run $PROG1 "test1 - 46" "arg1: 0 arg2: (none) oStr: yadda" --optional yadda
run $PROG1 "test1 - 47" "arg1: 0 arg2: (none) oStr: ping rest: pong" --optional=ping pong
run $PROG1 "test1 - 48" "arg1: 0 arg2: (none) oStr: ping rest: pong" --optional ping pong
run $PROG1 "test1 - 49" "arg1: 0 arg2: (none) aArgv: A B rest: C" --argv A --argv B C

run $PROG1 "test1 - 50" "arg1: 0 arg2: foo=bar" -2foo=bar
run $PROG1 "test1 - 51" "arg1: 0 arg2: foo=bar" -2=foo=bar

run $PROG1 "test1 - 52" "arg1: 0 arg2: (none) aFlag: 0xfeed" --bitxor
run $PROG1 "test1 - 53" "arg1: 0 arg2: (none) aFlag: 0xffff" --bitset
run $PROG1 "test1 - 54" "arg1: 0 arg2: (none) aFlag: 0x28c" --bitclr
run $PROG1 "test1 - 55" "arg1: 0 arg2: (none) aFlag: 0x8888" --nobitset
run $PROG1 "test1 - 56" "arg1: 0 arg2: (none) aFlag: 0xface" --nobitclr

run $PROG1 "test1 - 57" "arg1: 0 arg2: (none) aBits: foo,baz" --bits foo,bar,baz,!bar

run $PROG1 "test1 - 58" "test1: bad argument --arg1=illegal: option does not take an argument" --arg1=illegal
run $PROG1 "test1 - 59" "test1: bad argument --=illegal: option does not take an argument" --=illegal
...
run $PROG2 "test2 - 52" "Have your way. Have Fun" -Y "Have your way. Have Fun"
###################
# End test2 test
###################
###################
...
run_diff $PROG4 "test3 - 1" $base/test3-data/01.input $base/test3-data/01.answer
run_diff $PROG4 "test3 - 2" $base/test3-data/02.input $base/test3-data/02.answer
run_diff $PROG4 "test3 - 3" $base/test3-data/03.input $base/test3-data/03.answer
...
[ -s $base/popt-valgrind-result ] && { echo "Some test fail under Valgrind. Check $base/popt-valgrind-result" && exit 1 ; }

rm -f $base/popt-valgrind-result 
